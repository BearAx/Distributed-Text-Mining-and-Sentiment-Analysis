...
|----------|-------------|--------|
| Dataset loading | Raw dataset is available and readable | `[Status]` |
...
| Documentation | README and role-specific docs prepared | `[Status]` |
...
The project is intentionally modular so that each team member can complete a clearly defined part while the final system remains coherent, testable, and presentation-ready.

This directly supports the three evaluation dimensions:

- **Functionality** through correct implementation of the processing pipeline;
- **Design and Documentation** through explicit architecture and well-structured outputs;
- **Oral Presentation** through clear stage ownership, understandable logic, and demo-friendly artifacts.
